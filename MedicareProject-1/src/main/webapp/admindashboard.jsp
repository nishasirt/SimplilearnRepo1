...
<td><form action="updatemedince"><input type="hidden" name="mid"  value="<%=es.getMid() %>"><input type="submit"  value="Edit" class="btn btn-warning"></form></td>
<td><form action="deletemedicine"><input type="hidden" name="mid"  value="<%=es.getMid() %>"><input type="submit"  value="Delete" class="btn btn-danger"></form></tr>
<% }%>
</table>

...
%>
	...
	<table >
        ...
        <tr><td>Name :</td><td><input type="text" placeholder="Enter User Name"  name="username" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1"></td></tr>

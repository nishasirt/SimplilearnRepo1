...
%>
	...
	<ul class="list-group list-group-horizontal" >
        <li class="list-group-item"><a href="userdash.jsp">Home</a></li>
       
        <li class="list-group-item"><a href="categorypage.jsp"> Category</a></li>
        <li class="list-group-item"><a href="aboutus.jsp">About us</a></li>
         <li class="list-group-item"><a href="contactus.jsp">Contact us</a></li>
        
       <li class="list-group-item" ><a href="userlogin.jsp">Logout</a></li>
...
<table>
<tr><td>
	<img width="150" height="150" style="border: 5px solid #555;"
							src="data:image/jpg;base64,<%=base64Encoded1%>">
							
							
							<h3 ><%=m.getMname() %></h3>
							
							<%if(m.getStatus().equals("Enable"))
{%>
	<h4   style="color: green;">In Stock</h6>
	<% }else{
	
		%>
	<h4   style="color: red;">Out of Stock</h6>
		<% 
	}
	%>
	</td>
	...
	<td>
	<h4 >Category : <%=m.getCategory().getCname() %></h4>
	<h4 >Price : <%=m.getPrice() %></h4>
	<form action="/addcart">
	Quantity : <input type="text"   maxlength="2" size="2" required="required"  name="quan" >
	<input type="hidden" name="mid"   value="<%=m.getMid() %>">	<br>
	<input type="submit"  value="Add to card" class="btn btn-info"></form>
	<br>
	<form action="/getcartdata">
	
	<input type="hidden" name="mid"   value="<%=m.getMid() %>">
	<input type="submit"  value="go to cart" class="btn btn-primary"></form>
...
<div  class="footer"  >@Copyright by Nisha Chouhan <div align="right"></div>
</body>
</html>
...
<tr><th>&nbsp;Image  &nbsp; </th><th>&nbsp;Medicine id &nbsp; </th><th>&nbsp;Medicine name&nbsp;</th><th>&nbsp;Price&nbsp;</th><th>&nbsp;Category&nbsp;</th><th>&nbsp;Status&nbsp;</th></tr>
...
<td><form action="getallbyid"><input type="hidden" name="mid"  value="<%=es.getMedince().getMid() %>"><input type="submit"  value="Click to buy" class="btn btn-warning"></form></td>
